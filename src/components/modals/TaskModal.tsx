                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    {editingTask && (
                      <button
                        ...
                        className={`px-3 py-2 rounded-xl border transition-all cursor-pointer flex items-center gap-1.5 text-xs font-black shadow-xs active:scale-95 ${copiedLink
                                  ...
                                  .map((emp) => {
                                    ...
                                    return (
                                      <div
                                        ...
                                        className={`flex items-center justify-between p-2 rounded-xl cursor-pointer transition-colors ${isSelected
                                        ...
                                        <div className="flex items-center gap-2.5 min-w-0">
                                          {emp.avatarUrl ? (
                                            <img
                                              src={emp.avatarUrl}
                                              alt={emp.name}
                                              className={`w-7 h-7 rounded-full object-cover ring-2 ${isSelected ? 'ring-[#E4007E]' : 'ring-[#2E2E2E]'
                                                }`}
                                            />
                                          ) : (
                                            <div
                                              className={`w-7 h-7 rounded-full font-bold text-xs flex items-center justify-center ring-2 ${isSelected
                                ...
                                .map((c) => {
                                  ...
                                  return (
                                    <div
                                      ...
                                      className={`flex items-center gap-2.5 p-2 rounded-xl cursor-pointer transition-colors ${isSelected ? 'bg-[#262626] border border-[#E4007E]/50' : 'hover:bg-[#1C1C1C] border border-transparent'
                                        }`}
                                    >
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between gap-1.5 min-w-0">
                        <div className="flex items-center gap-1.5 min-w-0">
                          <div
                            className={`p-1 rounded-lg text-white shrink-0 flex items-center justify-center font-black ${isPsd
                      ...
                      <div className="flex items-center justify-end gap-1.5 pt-2 border-t border-[#2E2E2E] relative">
                        ...
                        <div className="relative">
                          <button
                            ...
                            className={`p-2 rounded-xl transition-all border cursor-pointer active:scale-95 ${openAttachmentMenuId === att.id
